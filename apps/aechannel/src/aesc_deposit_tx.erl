...
process(#channel_deposit_tx{channel_id  = ChannelId,
    ...
    Channel1      = aesc_channels:deposit(Channel0, Amount, Round),
...
channel_id(#channel_deposit_tx{channel_id = ChannelId}) -> ChannelId.

state_hash(#channel_deposit_tx{state_hash = StateHash}) -> StateHash.

updates(#channel_deposit_tx{from = From, amount = Amount}) ->
    [aesc_offchain_state:op_deposit(From, Amount)].
